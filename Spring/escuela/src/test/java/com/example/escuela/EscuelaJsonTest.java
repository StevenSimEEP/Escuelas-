...
class EscuelaJsonTest {
    ...
    @Test
    void escuelasDeserializationTest() throws IOException {
       String expected="""
             [
       			{"id": 99, "nombre": "Bedoya" },
       			{"id": 100, "nombre": "Montalvo" },
       			{"id": 101, "nombre": "Luxemburgo" }
       		]
             """;
       assertThat(jsonList.parse(expected)).isEqualTo(escuelas);
    }
}
